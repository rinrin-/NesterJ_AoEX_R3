...
patched source files are based on "public beta 3" (not latest beta 4)
...
about nestoy database

  if 'nesdbase.dat' exists in the same directory of nester.exe,
  nester fix header infomation when load ROM image.

  of course nestoy database has some errors,
  but nester can correct all errors i know.

  you can download at (latest rev is 11/07/2000):
  http://www.kinox.org/rca/nestoy.html
...
about Nintendo Disk System (mapper #20)
  ...
  * support save datas written to disk, saved as "*.sdk"

  * support ExtraSound.

  * shortcut key to change disk side:
   ...
   you can also change disk side in menu.
...
about VS Unisystem
  ...
  * supported games are:
    ...
    - Stroke and Match Golf (Alt)
    - Stroke and Match Golf (Ladies Edition)
    - Super Mario Bros
    - Super Mario Bros (Alt)
    - Super Skater (Bootleg)
    - Super Sky Kid
    - Tetris
    - TKO Boxing

  * not support VS Dualsystem games
...
mailto: t-takeda@m1.interq.or.jp
RUL:    http://www.emulation9.com/takeda/
